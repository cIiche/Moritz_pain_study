...
xlabels = {'Baseline', 'during 5 min of US stim', 5, 10, 15, 20, 25, 30, 35, 40, 45} ;
p1 = plot(y1, 'o-g','DisplayName','rat 1') ;
hold on 
y2 = [0.8072 0.8177 0.8431 0.8257 0.9958 0.791 0.7731 0.7740 0.8564 0.7484 0.8049 ] ;
p2 = plot(y2, 'o-r','DisplayName','rat 2') ;
hold on 
y3 = [0.2991 0.2798 0.2890 0.4836 0.3891 0.2541 0.2890 0.2488 0.3916 0.3873 0.4288] ;
p3 = plot(y3, 'o-b','DisplayName','rat 3') ;
set(gca,'xtick',[1:11],'xticklabel',xlabels)
title('RIL & RBLA Coherence (5-8Hz) vs. Time after US Stimulation')
xlabel('Time after US Stim ends (minutes)') 
ylabel('Coherence value') 
legend([p1 p2 p3],{'rat 1','rat 2', 'rat 3'})

figure 
y1 = [0.7099 0.7041 0.6962 0.6479 0.6928 0.7060 0.6576 0.6855 0.6547 0.6558 0.6738];
